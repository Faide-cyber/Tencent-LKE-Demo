    ...
    <div class="layout-wrap">
        <header class="layout-header">
            <div class="container" data-flex="main:justify cross:start">
                ...
                <div class="header-logo">
                    <h2 class="logo"><a class="links" href="https://5300.cn/chat/" target="_blank"><span class="logo-title">AI对话</span></a></h2>
                </div>
            </div>
        </header>
...
-->
                            ...
                            <div class="input-group">
                                <select id="model_type" style="max-width:250px;margin:5px 4px;background: #444;color:#999;/*width:calc(100% - 90px);*/">
                                    <option value="">AI大模型(请选择)</option>
                                    <option value="glm-4-flash" selected>智谱AI（GLM-4-Flash，不联网）</option>
                                    <option value="generalv3.5">讯飞星火（Spark Max，联网）</option>
                                    <option value="general">讯飞星火（Spark Lite，不联网）</option>
                                    <!--option value="ERNIE-Speed-128K">百度千帆（ERNIE-Speed-128K）</option-->
                                    <option value="internlm2.5-latest">书生浦语（internlm2.5-latest，不联网）</option>
                                    <option value="moonshot-v1-8k">Kimi.ai（moonshot-v1-8k，不联网）</option>
                                    <option value="ep-20241011220923-btqr7">豆包AI（Doubao-lite-4k，不联网）</option>
                                    <option value="deepseek-v3">深度求索(DeepSeek-V3)</option>
									                  <!--<option value="ep-20241011225913-6t2p2">豆包AI（Doubao-pro-4k，不联网）</option>
                                    <option value="ep-20241008224821-kj2sj">豆包AI（Doubao-lite-32k，不联网）</option>
                                    <option value="ep-20241011223049-2wmpg">豆包AI（Doubao-pro-32k，不联网）</option>-->
									
                                    <!--<option value="Atom-13B-Chat">Llama Family（Atom-13B-Chat）</option>
                                    <option value="Atom-7B-Chat">Llama Family（Atom-7B-Chat）</option>
                                    <option value="deepseek-ai/DeepSeek-V2-Chat">硅基流动（deepseek-ai/DeepSeek-V2-Chat）</option>-->
                                    
                                </select>								
                                
                                <span style="text-align: center;color:#9ca2a8;display:none;">&nbsp;&nbsp;预设话术：</span>
                                <select id="preset-text" onChange="insertPresetText()" style="max-width:230px;margin:5px 4px;background: #444;color:#999;/*width:calc(100% - 90px);*/">
                                    <option value="">预设话术(请选择)</option>
						...
						<li class="article-content"><p class="line">您好！我是AI智能助手，有什么问题都可以问我。</p></li>
                        </ul>
                        ...
                        <div id="fixed-block">
                            <div class="precast-block" id="kw-target-box" data-flex="main:left cross:center">
                                <div id="target-box" class="box">
                                    <textarea name="kw-target" placeholder="在此提问，按 Ctrl+Enter 发送（请勿输入敏感话题）" id="kw-target" autofocus rows=1></textarea>
                                </div>
    ...
    <script src="js/chat.js?v2"></script>
